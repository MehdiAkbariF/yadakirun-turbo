...
export const SimpleProductCard = ({
  ...
  return (
    // ✅ تگ اصلی به div تغییر کرد
    <div className={`simple-product-card ${className || ''}`}>
      
      {/* ✅✅✅ دکمه افزودن به سبد خرید در گوشه بالا-چپ ✅✅✅ */}
      {onAddToCart && inStock && (
        <button 
          className="simple-product-card__add-btn"
      ...
      <Link href={href} className="simple-product-card__main-link">
