...
// تصویر گرافیکی ۴۰۴ با چرخ‌دنده واقعی
const NotFoundIllustration = () => (
  <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-md h-auto drop-shadow-xl">
    <style>{`
    ...
    {/* پس زمینه نوری */}
    <circle cx="200" cy="150" r="120" fill="currentColor" className="text-brand-primary opacity-5" />
    
    {/* عدد 4 اول */}
    <path 
      fillRule="evenodd"
      clipRule="evenodd"
      d="M95 220V200H110V180H95V100H75L25 180V200H75V220H95ZM75 180H50L75 140V180Z" 
      fill="currentColor" 
      className="text-text-primary" 
    />
    
    {/* 
      چرخ دنده وسط (جایگزین 0) 
      این آیکون دقیقاً همان پسی است که شما فرستادید
    */}
    <g className="gear-spin" style={{ transformBox: 'fill-box', transformOrigin: 'center' }}>
      {/* برای اینکه آیکون ۲۴ پیکسلی شما در فضای بزرگتر دیده شود آن را scale و translate کردیم */}
      <g transform="translate(136, 86) scale(5.3)"> 
        <path 
    ...
    <path 
      fillRule="evenodd"
      clipRule="evenodd"
      d="M335 220V200H350V180H335V100H315L265 180V200H315V220H335ZM315 180H290L315 140V180Z" 
      fill="currentColor" 
      className="text-text-primary" 
    />
    ...
    {/* المان‌های معلق */}
    <g className="float">
      <path d="M350 80L360 90L370 80L360 70L350 80Z" fill="currentColor" className="text-brand-accent" />
      <circle cx="50" cy="80" r="5" fill="currentColor" className="text-text-secondary" />
      <circle cx="300" cy="250" r="8" fill="currentColor" className="text-brand-primary opacity-50" />
    </g>
  </svg>
);
...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-bg-body">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          
          <div className="flex flex-col items-center lg:items-start text-center lg:text-right space-y-6 order-2 lg:order-1">
            <div className="space-y-2">
              ...
              >
                صفحه شما <span className="text-brand-primary">یافت نشد!</span>
              </Label>
              <Label 
                as="p" 
                size="sm" 
              ...
              >
                صفحه مورد نظر شما در سایت موجود نمی‌باشد. ممکن است آدرس را اشتباه وارد کرده باشید یا صفحه حذف شده باشد.
              </Label>
            </div>
